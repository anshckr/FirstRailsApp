...
RailsApp.Models.User = Backbone.Model.extend({
  ...
  toJSON: function(){ // Will be required duing user.save()
    ...
    parse: function(response){ // Will bre required after fetch
      debugger
    }
});
RailsApp.Collections.Users = Backbone.Collection.extend({
    url: 'users/'
    ...
    parse: function (response) {
        ...
        response.forEach(function(eachUser){
          var user = new RailsApp.Models.User(eachUser);
          var userView = new RailsApp.Views.User({model: user});
          userView.render();
        })
    }
});
RailsApp.View.Login = Backbone.View.extend({
  el: '#login-view',
...
RailsApp.Views.User = Backbone.View.extend({
    ...
    // render: function () {
    //   // this.$el.append(JST['tasks/view']({ model: this.model }));
...
;
RailsApp.Routers.Users = new (Backbone.Router.extend({
  // id: 'railsapp',
  routes: { '': 'index'
    , 'users/:id': 'show'
    , 'signup': 'instantiate'
...
var RailsApp = new (Backbone.View.extend({
  Models: {},
  Collections: {},
  Views: {},
  Routers: {},
